...
public class Prekladac {
    ...
    public static void main(String[] args) {
        ...
        if (authKey == null || authKey.isEmpty()) {
            JOptionPane.showMessageDialog(frame, "Nenalezen API klíč DeepL. Nastavte proměnnou prostředí DEEPL_AUTH_KEY nebo jej přidejte do souboru .env.", "Chyba API", JOptionPane.ERROR_MESSAGE);
            return;
        }
